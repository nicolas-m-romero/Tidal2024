...
const Footer = () => {
    return (
        <footer className="flex flex-col justify-end items-start min-h-full max-w-[80ch] px-4 mx-auto mb-4 rounded-lg w-full transition-all duration-300 ease-in-out pt-4">
            {/* Left Column */}
